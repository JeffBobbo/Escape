...
Level* Level::prefabTest()
{
  ...
  }
  {
    ...
    level->insert(SceneGraph::Level::FOREGROUND,
      new Platform({1.0, 0.3}, {-2.50, 1.0}));
  }
  {
    Platform* o = new Platform({1.0, 1.0}, {-5.0, 0.0}, 2.0, 0.0, 5000);
    level->insert(SceneGraph::Level::FOREGROUND, o);
  }
  {
    Platform* o = new Platform({1.0, 1.0}, {5.0, 0.0}, 0.0, 2.0, 5000);
    level->insert(SceneGraph::Level::FOREGROUND, o);
    Button* b = new Button({-2.5, 2.0}, -1);
  ...
  {
    Platform* o = new Platform({1.0, 1.0}, {0.0, 0.0}, 0.0, 2.0, 2000);
    level->insert(SceneGraph::Level::FOREGROUND, o);
  }
